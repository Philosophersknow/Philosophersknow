...
Status: Updated draft — awaiting owner review and approval
...
The platform is organised around five Intelligence Centres — Civic Intelligence, Compliance Intelligence, Skills and Workforce Intelligence, Candidate Intelligence, and Publishing Intelligence — each producing structured intelligence products from integrated evidence sources. All centres share a common evidence architecture, source traceability model, human review gate, and publishing infrastructure.
...
6. Cross-Centre Intelligence Infrastructure
   - Shared evidence architecture, source verification, DRMC analytical framework, and publishing studio.
   - Supports integrated intelligence products that draw across multiple centres.
   - Managed by AIIPD_ADMIN and AIIPD_ANALYST roles.
...
- Terminology on the public site should align with the AIIPD Civic Intelligence content style guide (see `/content/governance/style-guide.md`).
- The URL path `council-benchmark/` should be updated to `civic-intelligence/` in Phase 1 navigation work. [Migration note: update anchor references before changing.]
...
- Civic Intelligence Centre. [Migration note: rename from "Council Intelligence Dashboard" to "Civic Intelligence Centre" in Phase 0 cleanup.]
- Evidence workspace.
- Report workspace.
- Admin import page.
- API assistant route.
...
- BenchmarkScore, ReadinessScore. [Migration note: rename BenchmarkScore to IntelligenceScore in Phase 0 cleanup.]
- CouncilAction.
- ReportOutput.
- ImportRun, ImportError.

Current report types:
- BENCHMARK. [Migration note: rename to PLACE_INTELLIGENCE_REPORT — see target nomenclature below.]
- MAYOR_BRIEF.
- BUDGET_IMPACT.
- COUNCILLOR_INFO_PACK.

Target report type nomenclature (for Phase 1 migration):
- BENCHMARK → PLACE_INTELLIGENCE_REPORT
- MAYOR_BRIEF → EXECUTIVE_INTELLIGENCE_BRIEF
- BUDGET_IMPACT → BUDGET_IMPACT_INTELLIGENCE
- COUNCILLOR_INFO_PACK → COUNCIL_INTELLIGENCE_PROFILE

[Migration note: add new enum values, migrate existing records, deprecate old values — do not delete until all reports migrated.]
...
Intelligence outputs must also carry:
- Intelligence pathway (which of the five centres produced it).
- Intelligence type (report, brief, profile, assessment, register).
- Evidence synthesis method (manual, AI-assisted, automated — clearly labelled).
- Human review gate status (draft, under review, approved, published).
- Applicable DRMC analytical lens where used.
...
Report naming must follow the Intelligence Centres taxonomy:
- Civic Intelligence outputs: Place Intelligence Reports, Governance Intelligence Reviews, Community Intelligence Profiles, Budget Impact Intelligence Briefs, Policy Shock Impact Reports.
- Compliance Intelligence outputs: Compliance Readiness Reports, Evidence Registers, Audit Preparation Packs.
- Skills Intelligence outputs: Skills Demand Reports, Course Opportunity Reports, Workforce Signal Briefs.
- Candidate Intelligence outputs: Candidate Intelligence Briefs, Local Area Intelligence Reports, Position Papers.
- Publishing Intelligence outputs: Learner Guides, Assessor Guides, White Papers, Executive Briefings.

Full terminology reference: `/content/governance/style-guide.md`
...
### 17.4 Intelligence Framing Safeguards
...
## 24. Content and Terminology Governance

### 24.1 Style Guide Reference

All platform content — website, portal, reports, AI prompts, onboarding and marketing — must follow the AIIPD Civic Intelligence Editorial Style Guide:

`/content/governance/style-guide.md`

This guide defines preferred terms, terms to avoid, capitalisation rules, report naming conventions, and audience-specific tone guidelines.

### 24.2 Content Architecture

The following content files define the publish-ready platform content. All development, design, and product decisions should align with these files:

| File | Purpose |
|---|---|
| `content/website/homepage.md` | Homepage content, repositioning rationale, visual and UX notes |
| `content/website/platform-overview.md` | Full platform description |
| `content/website/for-local-government.md` | Local government audience page |
| `content/website/for-state-government-and-policy.md` | State government and policy audience page |
| `content/website/for-consultants-and-researchers.md` | Consultants and researchers audience page |
| `content/dashboard/dashboard-language-guide.md` | 58 UI term transformations for all dashboard elements |
| `content/reports/report-types-and-templates.md` | Complete 12-report intelligence taxonomy |
| `content/reports/report-executive-summaries.md` | Executive summary templates for all report types |
| `content/marketing/value-proposition-library.md` | Value propositions, pitches, FAQs, email and LinkedIn copy |
| `content/marketing/competitive-differentiation.md` | Differentiation from benchmarking tools and alternatives |
| `content/onboarding/onboarding-scripts.md` | Welcome emails, tooltips, video script, 30-day milestones |
| `content/onboarding/onboarding-ui-copy.md` | All onboarding UI copy |
| `content/ai-prompts/system-prompts.md` | 12 production AI system prompts (old vs new framing) |
| `content/ai-prompts/ai-response-templates.md` | Standard AI response templates |
| `content/product/feature-descriptions.md` | 12 feature descriptions for website and proposals |
| `content/product/pricing-and-tiers.md` | 4-tier pricing structure and positioning |
| `content/governance/style-guide.md` | Full editorial style guide |

### 24.3 Codex-to-Claude Routing

For handoffs between Claude and Codex, use routing key: `AIIPD-BRIDGE-CLAUDE-TO-CODEX-V1`

Codex handles: technical implementation, build fixes, schema migrations, code generation.
Claude handles: content strategy, intelligence framing, report templates, AI prompts, editorial review.

### 24.4 Missing File Note

No `AGENTS.md` file was found in the repository as of this update. An `AGENTS.md` should be created to define agent roles, responsibilities, and handoff protocols between Claude and Codex. [Action required: create AGENTS.md — Liam to approve content before creation.]
